...
public abstract class ImageWorker {
	 ...
	 */
	public void loadImage(Object data, String referer, ImageView imageView) {
		Bitmap bitmap = null;
		...
		if (bitmap != null) {
		    ...
		    if (imageView instanceof ScaleImageView) {
		        ScaleImageView view1 = (ScaleImageView)imageView;
		        view1.setImageWidth(bitmap.getWidth());
		        view1.setImageHeight(bitmap.getHeight());
		    }
	 ...
	 *            The ImageView to bind the downloaded image to.
	 */
	public void loadImage(int num, String referer, ImageView imageView) {
		if (mImageWorkerAdapter != null) {
			loadImage(mImageWorkerAdapter.getItem(num), referer, imageView);
		} else {
	 ...
	 */
	protected abstract Bitmap processBitmap(Object data, String referer);
	...
	private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
		...
		protected Bitmap doInBackground(Object... params) {
			...
			// TODO  测试图片加载完成后修改大小
            if (bitmap != null && imageViewReference.get() instanceof ScaleImageView) {
                ScaleImageView view1 = (ScaleImageView)imageViewReference.get();
                view1.setImageWidth(bitmap.getWidth());
                view1.setImageHeight(bitmap.getHeight());
            }
