...
public class ImageFetcher extends ImageResizer {
    ...
    public static final String HTTP_CACHE_DIR = "http";  // 缓存目录
...
//        }
    ...
    @Override
    protected Bitmap processBitmap(Object data, String referer) {
        return processBitmap(String.valueOf(data), referer);
    }
     ...
     */
    public static File downloadBitmap(Context context, String urlString, String referer) {
